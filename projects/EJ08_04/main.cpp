...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light,
    ...
    s_phong.set("light.emissive", 1.0f, 0.0f, 0.0f); // Definimos un color para la emision, por si se necesitara cambiar el color.

    t_albedo.use(s_phong, "material.diffuse", 0);
    t_specular.use(s_phong, "material.specular", 1);
    t_emissive.use(s_phong, "material.emissive", 2); // Anadimos el material de emision.
...
int main(int, char* []) {
    ...
    const Texture t_emissive("../assets/textures/EJ08.04_emissive.jpg", Texture::Format::RGB);
