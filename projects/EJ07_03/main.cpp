...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light) {
    ...
    /*
        Cambiamos tres vectores/matrices al espacio de la vista:
            - matriz de normales
            - posicion de la luz
            - posicion de la camara
            - posicion de los fragmentos (cambiado en el shader de vertices --> phong.vs)
    */
    glm::mat3 normalMat = glm::inverse(glm::transpose(glm::mat3(view) * glm::mat3(model))); // Convertimos la matriz de normales a espacio de vista
    ...
    s_phong.set("lightPos", glm::vec3(view * glm::vec4(lightPos, 1.0f))); // Pasamos la posicion de las luces a espacio de vista

    s_phong.set("viewPos", view * glm::vec4(camera.getPosition(), 1.0f));
