...
int main(int, char* []) {
    ...
    const Shader s_phong("../projects/EJ07_04/phong.vs", "../projects/EJ07_04/blinn.fs");
    const Shader s_light("../projects/EJ07_04/light.vs", "../projects/EJ07_04/light.fs");
    const Sphere sphere(1.0f, 20, 20); // Reducimos el numero de triangulos por el que esta compuesta la esfera para ver mejor el efecto de Gouraud. Al utilizar el shader nuevo, podemos distinguir los vertices / aristas de algunos triangulos ya que la luz se esta definiendo en ellos. Por otro lado, si se utiliza los shaders originales (AG07), se puede ver como la luz esta uniforme sobre la superficie, sin distinguir los triangulos.
