...
void render(const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light,
    ...
    s_phong.set("light.ambient", 0.1f, 0.1f, 0.1f); // Al cambiar la luz ambiental, cambiara la luz que el ambiente emite sobre la esfera. De esta forma, al ponerla como color rojo (1.0, 0.0, 0.0), la esfera pasara a ser de color rojo en su completitud.
    s_phong.set("light.diffuse", lightDiffuse); // Al cambiar la luz diffuse, cambiara la luz que emite el punto de luz sobre la esfera. De esta forma, si se pone como color rojo (1.0, 0.0, 0.0), la parte de la esfera que mira hacia la luz aparecera roja. 
    s_phong.set("light.specular", 1.0f, 0.0f, 0.0f); // Al cambiar la luz specular, cambiara la luz que refleja la esfera
