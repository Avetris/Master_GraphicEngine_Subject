...
void render(const Geometry& geom, const Shader& shader, Texture& tex) {
    ...
    shader.set("view", camera.getViewMatrix(true)); // Se ha modificado el metodo getViewMatrix para que realice la comprobacion de lookAt manualmente en caso de recibir el parametro a true. Se ha implementado la funcion segun OPEN GL --> Right_Hand
